...
public class Painter {
    ...
    public static void markTaskList(boolean mark, Task[] taskList, int nTasks, int n) {
        ...
        if (mark) {
            ...
            printSentence("Nice! I've marked this task as done: [X] " + taskList[n - 1].getDescription());
        } else {
            taskList[n - 1].markAsUndone();
            printSentence("OK, I've marked this task as not done yet: [ ] " + taskList[n - 1].getDescription());
        }
    }
    ...
    public static void main(String[] args) {
        printSentence("Hello! I'm Painter\nWhat can I do for you?");
